      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <main className="relative z-10 text-center px-4 -translate-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link 
              to="/bracket"
              className="cal-sans-regular bg-white text-base sm:text-xl md:text-2xl text-black px-4 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors w-full sm:w-auto inline-block text-center"
            >
              Bracket View
            </Link>
            <button 
              onClick={scrollToPoster}
              className="cal-sans-regular border text-base sm:text-xl md:text-2xl border-white/30 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:bg-white/10 transition-colors w-full sm:w-auto"
            >
              Learn More
            </button>
          </div>
