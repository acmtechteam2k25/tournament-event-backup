        ...
        round1Matches.forEach((match) => {
          console.log(`Round 1 Match ${match.match_number}:`, {
            winner: match.winner_id
              ? match.player1?.id === match.winner_id
                ? match.player1.name
                : match.player2?.name
              : "No winner yet",
          ...
          participants: [
            match.player1
              ? {
                  ...
                  resultText:
                    match.winner_id === match.player1.id ? "WINNER" : null,
            ...
            match.player2
              ? {
                  ...
                  resultText:
                    match.winner_id === match.player2.id ? "WINNER" : null,
    ...
    if (!isCurrentlySelected && match) {
      ...
      if (match.state === "SCORE_DONE") {
        ...
        if (winner) {
          ...
          setLoserScore("8");
          setIsWalkover(
            winner.status === "walkover" || loser?.status === "walkover"
          );
        } else {
            ...
            {!isWalkover && selectedWinner && (
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      {selectedMatch.participants.find(
