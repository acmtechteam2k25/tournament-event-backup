        ...
        {Object.keys(matchesByRound).sort((a, b) => parseInt(a) - parseInt(b)).map(round => (
          <div key={round} className="mb-10">
            <div className="text-center mb-6">
              <h3 className="inline-block text-2xl font-bold text-white bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-2 rounded-full shadow-lg">
            ...
            {matchesByRound[round].map(match => (
              <div 
                key={match.match_id} 
                className={`bg-white rounded-xl shadow-lg p-5 transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1 ${
