-- CRITICAL FIX: Run this in Supabase SQL Editor to fix bracket loading
-- This fixes the "column m.match_name does not exist" error
...
-- Test the function (should return results without errors)
SELECT COUNT(*) as bracket_function_test 
